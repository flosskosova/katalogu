 ...
 * - **Production builds** (`NODE_ENV=production`): `NEXT_PUBLIC_TURNSTILE_SITE_KEY_PRODUCTION`, then `NEXT_PUBLIC_TURNSTILE_SITE_KEY`.
 *   Missing production keys intentionally return an empty value so UI can block submit without
 *   crashing prerender/build.
